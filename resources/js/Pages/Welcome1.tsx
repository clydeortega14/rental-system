...
const slides = [
  { image: card1, text: 'Rent all you can, explore more than you ever imagined!', text1: '"Unlock endless possibilities with our renting services" ' },
  { image: card2, text: 'Rent a House, explore more than you ever imagined!', text1: '"Unlock endless possibilities with our renting services" ' }
          ...
          <Slider {...carouselSettings}>
            ...
            {slides.map((slide, index) => (
              <div key={index} className="relative">
                <img src={slide.image} alt={`Carousel Image ${index + 1}`}  className="object-stretch h-[500px] w-full" />
                <div className="absolute inset-0 flex flex-col justify-between text-white text-2xl font-semibold px-7">
                  <div>
                   
                    <div className="hidden sm:flex sm:justify-left mt-12" style={{marginTop:'150px'}}>
                      <div className="relative rounded-full px-3 py-1 text-sm leading-8 justify-between text-white-500 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                        Check our new Rent Promo.{' '}
                    ...
                    <div className="text-left mt-12" style={{marginTop:'30px'}}>
                      <h1 className="text-4xl  font-bold tracking-tight text-white-900 lg:text-2xl">
                     {slide.text}
                      </h1>
                      <p className="mt-2 text-lg leading-8 text-orange-600  shadow-sm ">
                      {slide.text1}
                      </p>
                      <div className="mt-12 flex items-center justify-left gap-x-6">
                        <a
                          href="#"
