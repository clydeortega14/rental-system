            ...
            <div className="max-w-9xl mx-auto sm:px-6 lg:px-2">
                ...
                <div className="flex flex-col gap-6 h-full">
                    ...
                    <div className="flex-1">
                        ...
                        I offer rent options for gadgets, houses, apartments, hotels,
                        and all kinds of rentals across the Philippines.
                        </p>
                        ...
                        <a href="/reservations" className="bg-gray-600 text-white px-4 py-2 rounded-lg flex items-center hover:bg-blue-700 transition">
                            <i className="ti ti-eye mr-2" /> Reservations
                        </a>
                        <a href="/lessor" className="bg-orange-500 text-white px-4 py-2 rounded-lg flex items-center hover:bg-gray-900 transition">
                    ...
                    <div className="w-full max-w-xs mt-6 lg:mt-0 lg:ml-4">
                        <img src={icon} alt="Welcome Illustration" className="object-contain w-full h-full" />
                    </div>
                    </div>
                ...
                <div className="bg-white shadow rounded-lg p-6 flex flex-col justify-between">
                    ...
                    <a href="/cars" className="text-blue-600 underline text-sm font-medium hover:text-blue-800 transition">View All</a>
                    </div>

                    <div className="mb-4">
                    <img src={banner} alt="New Car" className="rounded w-full object-cover" />
                    </div>
