    ...
    <RenterLayout>
      ...
      >
        <div className="relative max-w-7xl mx-auto px-4 text-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4">Rent anything, anywhere.</h1>
          <p className="text-base sm:text-lg md:text-xl text-gray-200">
            Cars for the open road, properties for the night, and gear for the trip — browse what's available and book in minutes.
          </p>
        </div>
      </section>    
