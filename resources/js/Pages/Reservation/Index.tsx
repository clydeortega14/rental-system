...
function Index({ auth, headerData,  bodyData} : PageProps<{headerData: string, bodyData: string }>) {
	...
	return (
		...
		<AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-base text-gray-800 leading-tight">Reservations</h2>}
        >
